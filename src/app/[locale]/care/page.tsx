    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 py-12 px-6">
        <div className="container mx-auto max-w-3xl flex flex-col gap-8">
          ...
          />
          <BlogCard 
            title="Dental Disease Prevention in Small Herbivores"
            excerpt="Rabbits and guinea pigs have continuously growing teeth. Discover why proper hay consumption is medically necessary to prevent severe dental disease and abscesses."
            authorName="Dr. Alan Choi"
            authorCredential="DVM, Exotic Companion Mammals"
            date="2026-06-10"
            slug="dental-disease-prevention-herbivores"
          />
        </div>
      </main>
    </div>
