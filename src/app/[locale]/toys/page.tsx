...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      description: t('subtitle'),
      url: `https://mondopets.com/${locale}/toys`,
      siteName: 'Mondo Pets',
      images: [
        {
...
export default async function ToysPage({ 
  ...
  const t = await getTranslations({ locale, namespace: 'ToysPage' });
  const products = await getProducts('toy', undefined, sort, { minPrice, maxPrice, lifeStage, brand, petType, minRating });
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 py-8 px-6">
        <div className="container mx-auto flex flex-col md:flex-row gap-8">
          ...
          <SidebarFilters categories={categories} basePath="/toys" />
